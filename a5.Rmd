...
```{r}
no_cred_id = accounts[is.na(accounts$credit_cards),]$account_id
transactions2 = transactions[transactions$account_id==no_cred_id,]
transactions2[transactions2$type=='credit',]
transactions2
```
